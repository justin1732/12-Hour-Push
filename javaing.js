document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(index){
        squares[i].onclick = function(){
            ...
            //square is taken    
            } else alert ("I can't let you do that, Star Fox!")
        }
    })(i)
    ...
    function checkBoard (){
        ...
        //plugging arrays into the squares
    ...
    //now checking if the arrays all are owned by the first player
...
//now checking for the second player 
...
//add an eventLister to each square to trigger the checkBoard function
